        ...
        if ("0" == resp.errno) {
            ...
            if (areaId) {
                for (var i=0; i<resp.data.length; i++) {
                    ...
                    // 判断当前遍历的城区id是否是要搜索的城区id，如果是，就给指定的标签设置选择 active
                    if (resp.data[i].aid == areaId) {
